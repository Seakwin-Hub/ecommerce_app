...
class CustomThemeStyle {
  ...
  static TextTheme textThemeCustom(Color color) => TextTheme(
        ...
        labelLarge: TextStyle().copyWith(
            fontSize: 12.sp, fontWeight: FontWeight.normal, color: color),
  ...
  static ChipThemeData chipTheme(Color disabledColor, Color labelColor) =>
      ChipThemeData(
        disabledColor:
            disabledColor, // light: Colors.grey.withValues(alpha: 0.4), dark: Colors.grey
        labelStyle: TextStyle(
            color: labelColor), //light : Colors.black, dark : Colors.white
  ...
  static OutlinedButtonThemeData outlinedButtonTheme(
      ...
      OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          side: BorderSide(
              color:
                  borderColor), //light: Colors.blue, dark : Colors.blueAccent
          textStyle: TextStyle(
            fontSize: 16.sp,
            fontWeight: FontWeight.w600,
  ...
  static InputDecorationTheme inputDecorationTheme(
      ...
      InputDecorationTheme(
        ...
        labelStyle: TextStyle().copyWith(
            fontSize: 14.sp,
            color: color), // is dark color:white, light: color:black
        ...
        focusedBorder: OutlineInputBorder().copyWith(
          ...
          borderSide: BorderSide(
              width: 1,
              color: focusColor), // is dark color:white, light: color:black12
        ),
